# Podplane Individual Contributor License Agreement ("Agreement")

Thank you for your interest in Podplane, an open source ecosystem owned or managed by Nadrama Pty Ltd (the "Company").

To clarify the intellectual property license granted with Contributions from any person or entity, the Company must have on file a signed Contributor License Agreement ("CLA") from each Contributor, indicating agreement with the license terms below. This agreement is for your protection as a Contributor as well as the protection of the Company and its users. It does not change your rights to use your own Contributions for any other purpose.

Please complete and sign this Agreement using the signature request provided by the Company. The completed signed Agreement will be returned to the Company through that signature request. By signing this Agreement, You acknowledge that You have read this Agreement, accept and agree to its terms, and intend to be legally bound by it. The parties agree that this Agreement may be signed electronically and that an electronic signature has the same legal effect as a handwritten signature to the fullest extent permitted by applicable law.
...
1. Definitions.
   ...
   "Covered Projects" shall mean the Podplane open source ecosystem, including but not limited to Podplane, Nstance, Netsy, Easy OIDC, puidv7, Terraform/OpenTofu modules, Kubernetes operators, SDKs, websites, documentation, and related software owned or managed by the Company. The [Podplane CLA repository README](https://github.com/podplane/cla) may contain an illustrative, non-exhaustive list of Covered Projects.

   "Contribution" shall mean any original work of authorship, including any modifications or additions to an existing work, that is intentionally submitted by You to the Company for inclusion in, or documentation of, any of the Covered Projects or other products owned or managed by the Company (the "Work"). For the purposes of this definition, "submitted" means any form of electronic, verbal, or written communication sent to the Company or its representatives, including but not limited to communication on electronic mailing lists, source code control systems, and issue tracking systems that are managed by, or on behalf of, the Company for the purpose of discussing and improving the Work, but excluding communication that is conspicuously marked or otherwise designated in writing by You as "Not a Contribution."
...
9. This Agreement is governed by the laws of Victoria, Australia. The parties submit to the exclusive jurisdiction of the courts of Victoria, Australia and courts competent to hear appeals from those courts.
...
This is a legal contract and may contain personal information. Personal information submitted in connection with this Agreement is handled in accordance with Nadrama Pty Ltd's [Privacy Policy](https://nadrama.com/privacy).
